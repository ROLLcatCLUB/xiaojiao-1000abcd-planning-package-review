...
FINAL_STATUS = 'XIAOJIAO_EDUCATION_PRE_CLASS_WORK_SAMPLE_ROOM_BUSINESS_STRUCTURE_PASS'
SLUG = 'xiaojiao_education_pre_class_work_sample_room_business_structure_1000B'
...
REQUIRED_FILES = ['docs/handoff/xiaojiao_teacher_jarvis_workbench_1000A_execution_handoff_20260612.md', 'docs/handoff/teacher_jarvis_workbench_planning_notes_1000_20260612.md', 'docs/foundation/xiaojiao_education_pre_class_work_sample_room_business_structure_1000B.md', 'docs/foundation/xiaojiao_education_pre_class_work_sample_room_business_structure_1000B.json', 'docs/audit/xiaojiao_education_pre_class_work_sample_room_business_structure_1000B_report.md', 'docs/audit/xiaojiao_education_pre_class_work_sample_room_business_structure_1000B_result.json', 'docs/audit/xiaojiao_education_pre_class_work_sample_room_business_structure_1000B_checklist.json', 'docs/audit_packages/xiaojiao_education_pre_class_work_sample_room_business_structure_1000B_manifest.json', 'scripts/validate_xiaojiao_education_pre_class_work_sample_room_business_structure_1000B.py']
