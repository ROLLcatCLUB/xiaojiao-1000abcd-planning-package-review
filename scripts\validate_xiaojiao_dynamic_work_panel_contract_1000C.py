...
FINAL_STATUS = 'XIAOJIAO_DYNAMIC_WORK_PANEL_CONTRACT_PASS'
SLUG = 'xiaojiao_dynamic_work_panel_contract_1000C'
MARKER = 'ALL_1000C_DYNAMIC_WORK_PANEL_CONTRACT_CHECKS_OK'
NEXT_STAGE = '1000D_AGENT_ACTION_POLICY_AND_WORK_STATE_CONTRACT'
REQUIRED_FILES = ['docs/handoff/xiaojiao_teacher_jarvis_workbench_1000A_execution_handoff_20260612.md', 'docs/handoff/teacher_jarvis_workbench_planning_notes_1000_20260612.md', 'docs/foundation/xiaojiao_dynamic_work_panel_contract_1000C.md', 'docs/foundation/xiaojiao_dynamic_work_panel_contract_1000C.json', 'docs/audit/xiaojiao_dynamic_work_panel_contract_1000C_report.md', 'docs/audit/xiaojiao_dynamic_work_panel_contract_1000C_result.json', 'docs/audit/xiaojiao_dynamic_work_panel_contract_1000C_checklist.json', 'docs/audit_packages/xiaojiao_dynamic_work_panel_contract_1000C_manifest.json', 'scripts/validate_xiaojiao_dynamic_work_panel_contract_1000C.py']
